# Version 9/14/2024
# Added print statements in plot_inf_line() to check which points are vertically aligned
# Made tolerance variable global instead of local
# Modified how find_slope() would check for a vertical line using tolerance
# Discovered confusing problem about graphing two vertical lines, added print statements in graph_circle(), find_circ(), invert_circle(), and plot_inf_line()
# Discovered that I actually called plot_inf_line() twice because I called invert_circle() twice - once when I was actually inverting the circle, and once when I was printing the radius and center of the new inverted circle for debugging. Uh oh.
...
def find_circ(circumPts):
    ...
    if is_collinear(circumPts[0],circumPts[1],circumPts[2]):
        ...
        # plt.plot(xs, ys)
        print("The circumPts are collinear.")
