# Version 10/28/2024
# Deleted the past giant chunk of code about interAs, newInterAs, interBs, etc.; in ver. "test 1 succeeded", this code is only commented out
# Debugged - test cases #1 - #4 all work
# Set circle D color to gray
...
print("D for test case #5: " + str((hd,kd)))
