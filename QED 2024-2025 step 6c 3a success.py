# Version 11/4/2024
# Fixed newly discovered error in graph_first_four about circ D in straight configs - pg. 46 records
# Deleted old commented-out third-layer Ford code
# Created find_new_pos_straight
# Added parameter returnLists to graph_first_four
# Added get_inv() method in myCircle class
# Added get_pt1() and get_pt2() methods for myLine class
# Added scale_and_transl()
# Added find_nth_cent() and r_n()
# Added find_new_pos_circ()
# Imported Python Fraction
# Added find_new_pos()
# Added graph_new_pos()
# Changed graph_first_four() to first_four() and made graphing toggleable
# Had first_four() graph circO instead of putting it in the test section
# Added set_color() method to Figure class
# Fixed scale_and_transl()
# Added in old calculation functions and fixed get_inv()
# Test 1 works now, Test 2 has an error
# Fixed find_new_pos_straight() and also find_new_pos_circ() - pg. 51-52 records
# Test 2 works
# Test 5 errors
# Added error tolerance to get_inv() and added cases checking if a circle had inverted to a line object before running scale_and_translate
# Test 5 works, test 6 works
# Fixed dx and dy calculations - notes on pg. 52-53
# Test 7 works, test 8 works, all previous tests 1-6 also work
...
def graph_new_pos(ra,rb,rc,circO,config="circle",graphInversions=False):
