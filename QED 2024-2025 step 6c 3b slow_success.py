# Version 11/13/2024
# Added generate_gasket
# Added parameter to return the new circO in graph_new_pos()
# Made graphing function toggleable in create_Ford_Circles() by adding graph parameter
# Added graph parameter in next_three()
# Added returnList parameter to create_Ford_Circles()
# Added invert_future_layers()
# Added __str__ method to myLine class
# Test 1 works - took about 10 mins to run
# Changed tDist to 10
# Test 2 works - took about 10 mins to run
# Changed tDist to 15
# Test 5 and 6 work - 5 took about 10 mins to run
# Test 7 took 10 mins to run and half-failed - it was inaccurate and the flaws of the other cases were exemplified - image saved
# Got rid of plotting the Ford-to-circle-D inversion
